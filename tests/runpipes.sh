...
echo "--------------------------------------------"
echo "Last tool verbose, to STANDARD OUTPUT:"
...
echo "--------------------------------------------"
echo "Headers to aliases to fields_info to jwst_oc_calc to miss_report to no_op to pickle_sink, all DEBUG:"
headers -d -ff /images/DC_191217/F356W.fits | aliases -d | fields_info -d | jwst_oc_calc -d -ff /images/DC_191217/F356W.fits | miss_report -d | no_op -d | pickle_sink -d -g

echo "--------------------------------------------"
echo "Headers to aliases to fields_info to jwst_oc_calc to miss_report to no_op to pickle_sink, all SILENT:"
headers -ff /images/DC_191217/F356W.fits | aliases | fields_info | jwst_oc_calc -ff /images/DC_191217/F356W.fits | miss_report | no_op | pickle_sink -g

echo "--------------------------------------------"
echo "Pickle pipeline, generated filename, verbose:"
...
echo "--------------------------------------------"
echo "Last tool debug and generate filename:"
...
pickle_sink -d -if /work/hafijocmrnop.json -of /work/hafijocmrnoppk1.pickle
