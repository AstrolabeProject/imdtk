...
echo "--------------------------------------------"
echo "Headers to aliases to fields_info to jwst_oc_calc to miss_report to no_op to jwst_oc_pg_sink:"
headers -v -ff /images/DC_191217/F356W.fits | aliases -v | fields_info -v | jwst_oc_calc -v -ff /images/DC_191217/F356W.fits | miss_report -v | no_op -v | jwst_oc_pg_sink -v -sql -g
...
headers -v -ff /images/DC_191217/F356W.fits | aliases -v | fields_info -v | jwst_oc_calc -v -ff /images/DC_191217/F356W.fits | miss_report -v | jwst_oc_pg_sink -v -sql -g

echo "--------------------------------------------"
echo "PG SQL pipeline, named filename:"
headers -v -ff /images/DC_191217/F356W.fits | aliases -v | fields_info -v | jwst_oc_calc -v -ff /images/DC_191217/F356W.fits | miss_report -v | jwst_oc_pg_sink -v -sql -of /work/testql.sql

echo "--------------------------------------------"
echo "PG SQL pipeline, all DEBUG:"
headers -d -ff /images/DC_191217/F356W.fits | aliases -d | fields_info -d | jwst_oc_calc -d -ff /images/DC_191217/F356W.fits | miss_report -d | jwst_oc_pg_sink -d -sql -g

echo "--------------------------------------------"
echo "PG SQL pipeline, all SILENT:"
headers -ff /images/DC_191217/F356W.fits | aliases | fields_info | jwst_oc_calc -ff /images/DC_191217/F356W.fits | miss_report | jwst_oc_pg_sink -sql -g
...
jwst_oc_calc -d -ff /images/DC_191217/F356W.fits -if /work/hafi.json -of /work/hafijoc.json
miss_report -d -if /work/hafijoc.json -of /work/hafijocmr.json
jwst_oc_pg_sink -d -sql -if /work/hafijocmr.json -of /work/hafijocmr.sql
...
jwst_oc_calc -d -ff /images/DC_191217/F356W.fits -if /work/hafi1 -of /work/hafijoc1
miss_report -d -if /work/hafijoc1 -of /work/hafijocmr1
jwst_oc_pg_sink -d -sql -if /work/hafijocmr1 -of /work/hafijocmrsql1


echo "--------------------------------------------"
echo "Current development:"
# headers -v -ff /images/DC_191217/F356W.fits | aliases -v | fields_info -v | jwst_oc_calc -v -ff /images/DC_191217/F356W.fits | miss_report -v | jwst_oc_pg_sink -v
# headers -d -ff /images/DC_191217/F356W.fits | aliases -d | fields_info -d | jwst_oc_calc -d -ff /images/DC_191217/F356W.fits | miss_report -d | jwst_oc_pg_sink -d -g
# headers -v -ff /images/DC_191217/F356W.fits | aliases -v | fields_info -v | jwst_oc_calc -v -ff /images/DC_191217/F356W.fits | miss_report -v | jwst_oc_pg_sink -sql -v -of /work/testql.sql
# headers -v -ff /images/DC_191217/F356W.fits | aliases -v | fields_info -v | jwst_oc_calc -v -ff /images/DC_191217/F356W.fits | miss_report -v | jwst_oc_pg_sink -sql -v -g
