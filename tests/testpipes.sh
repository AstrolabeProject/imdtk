...
# fits_headers -ff /images/DC_191217/F356W.fits -ofmt xxx
# fits_headers -ff /images/DC_191217/F356W.fits | aliases -v -g -ofmt xxx
# fits_headers -ff /images/DC_191217/F356W.fits | aliases -v | pickle_sink -v
...
fits_headers -v -ff /images/JADES/goods_s_F356W_2018_08_30.fits -of /work/JADES_F356W_headers.json
...
echo "--------------------------------------------"
echo "FITS metadata to PostgreSQL JWST table pipeline:"
