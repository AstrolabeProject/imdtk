#!/usr/bin/env python
#
# Python pipeline to extract image metadata and store it into a PostreSQL/JSON hybrid database.
#   Written by: Tom Hicks. 11/25/2020.
...
def main (argv=None):
    ...
    parser = argparse.ArgumentParser(
        ...
        description='Pipeline to extract FITS image metadata and store it into a PostreSQL/JSON hybrid database.'
    )
